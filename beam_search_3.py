...
# "knn", "test_vectors" could be change in find_candidates
...
def find_candidates(trainvectors, testvectors, window_size):
  result = []
  ## define
  beam_width = 50
...
if __name__ == '__main__':
  ...
  ## get result
  actual = find_candidates(trainvectors, testvectors,2)
  ## pirnt out result
